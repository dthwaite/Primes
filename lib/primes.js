/**
 * @file Prime number implementation
...
(function() {
    ...
    /**
     * Object providing two methods: isPrime() and nextPrime(n)
     *
     * @type {{isPrime: Primes.isPrime, nextPrime: Primes.nextPrime}}
     */
    var Primes={
        ...
        nextPrime: function(number) {
            ...
            do {
                number+=(number%2==0 || number==1 ? 1 : 2);
            } while (!test(number));
            return number;
        }
    };
